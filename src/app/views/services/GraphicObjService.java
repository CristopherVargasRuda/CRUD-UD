...
public class GraphicObjService {

    private GraphicObjService() {
    }
    ...
    static private GraphicObjService servicio;
    ...
    public JScrollPane buildPanelBar(
    ...
    public JRadioButton buildJRadioButton(
            String texto, int x, int y, int ancho, int alto, Cursor cursor,
    ...
    public JCheckBox buildJCheckBox(
            String texto, int x, int y, int ancho, int alto, Cursor cursor,
            Font fuente, Color colorFuente
    ) {
    ...
    public JPasswordField buildJPasswordField(
            String texto, int x, int y, int ancho, int alto, Color colorFondo,
            Color colorFuente, Color colorCaret, Font fuente, Border borde,
            String direccion) {
    ...
    public static GraphicObjService getService() {
        if (servicio == null) {
            servicio = new GraphicObjService();
        }
        return servicio;
    }
